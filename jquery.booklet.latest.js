...
pageSelector.on('click.booklet', function () {
    ...
    $.fn.booklet.defaults = {
        ...
        closedFrontTitle:     'Beginning of Booklet',                     // used with "closed", "menu" and "pageSelector", determines title of blank starting page
        closedFrontChapter:   'Beginning of Booklet',             // used with "closed", "menu" and "chapterSelector", determines chapter name of blank starting page
        closedBackTitle:      'End',                           // used with "closed", "menu" and "pageSelector", determines chapter name of blank ending page
        closedBackChapter:    'End of Booklet',                   // used with "closed", "menu" and "chapterSelector", determines chapter name of blank ending page
